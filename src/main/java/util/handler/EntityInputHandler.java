...
public class EntityInputHandler {
    ...
    // todo добавить валидацию пустого список (примечание тип то что список пуст)
    // todo добавить валидацию того что список пуст и предупреждение что записывать нечего
    // todo добавить вывод отсортированный вывод или то что его нет
    // todo после ошибки сделать шаг назад чтоб была попытка заново в вести то что заново не ввёл
